...
public class GpsReceiver extends BroadcastReceiver {
    ...
    private void restartApp() {
        ...
        if (!currentActivity.getLocalClassName().equalsIgnoreCase("LauncherActivity")) {
            if (currentActivity != null && currentActivity instanceof MainActivity) {
                ((MainActivity) currentActivity).handleNoNetworkDial();
            } else if (currentActivity != null && currentActivity instanceof ActiveTripActivity) {
                Utils.printLog("ActiveTriphandleNoNetworkDial","::");
                ((ActiveTripActivity) currentActivity).handleNoNetworkDial();
            } else if (currentActivity != null && currentActivity instanceof DriverArrivedActivity) {

                ((DriverArrivedActivity) currentActivity).handleNoLocationDial();
