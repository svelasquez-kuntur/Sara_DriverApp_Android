...
import com.sara.driver.HistoryActivity;
...
//                        map.put("REQUEST_TYPE", generalFunc.getJsonValue("REQUEST_TYPE", message_json));
                        ...
                        if (Utils.checkText(generalFunc.getJsonValue("REQUEST_TYPE", message_json)))
                        {
                            if (generalFunc.getJsonValue("APP_TYPE", responseString).equalsIgnoreCase("Delivery"))
                            {
                                map.put("REQUEST_TYPE", "Deliver");
                            }
                            else
                            {
                                map.put("REQUEST_TYPE", generalFunc.getJsonValue("APP_TYPE", responseString));
                            }
                        }
                        else
                        {
