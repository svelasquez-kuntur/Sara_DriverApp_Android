                    ...
                    if (generalFunc.checkDataAvail(CommonUtilities.action_str, responseString) == true) {
                        ...
                        if (arr_rides != null && arr_rides.length() > 0) {
                            for (int i = 0; i < arr_rides.length(); i++) {
                                ...
                                //new parameters LBL_INSURANCE_UPLOAD_DOC -- LBL_LICENCE_UPLOAD_DOC --LBL_OWNERSHIP_UPLOAD_DOC -- LBL_IDENTIFICATION_UPLOAD_DOC
                                map.put("LBL_INSURANCE_UPLOAD_DOC", generalFunc.retrieveLangLBl("Insurance", "LBL_INSURANCE_UPLOAD_DOC"));
                                map.put("LBL_LICENCE_UPLOAD_DOC", generalFunc.retrieveLangLBl("Driving license", "LBL_LICENCE_UPLOAD_DOC"));
                                map.put("LBL_OWNERSHIP_UPLOAD_DOC", generalFunc.retrieveLangLBl("Car ownership card", "LBL_OWNERSHIP_UPLOAD_DOC"));
                                map.put("LBL_IDENTIFICATION_UPLOAD_DOC", generalFunc.retrieveLangLBl("Identification document", "LBL_IDENTIFICATION_UPLOAD_DOC"));
