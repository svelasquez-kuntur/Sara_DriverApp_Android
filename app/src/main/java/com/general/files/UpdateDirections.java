                    ...
                    if (status.equals("OK")) {
                        ...
                        if (obj_routes != null && obj_routes.length() > 0) {
                            ...
                            if (mcontext instanceof DriverArrivedActivity) {
                                ...
                                driverArrivedActivity.setTimetext(distance_final + "", time);
                            } else if (mcontext instanceof ActiveTripActivity) {
                                ActiveTripActivity activeTripActivity = (ActiveTripActivity) mcontext;
                                activeTripActivity.setTimetext(distance_final + "", time);
                            }
                        }


                        PolylineOptions lineOptions = generalFunctions.getGoogleRouteOptions(responseString, Utils.dipToPixels(mcontext, 5), mcontext.getResources().getColor(R.color.appThemeColor_1));
