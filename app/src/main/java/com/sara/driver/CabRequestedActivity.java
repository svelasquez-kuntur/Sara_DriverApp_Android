...
//        playMedia();
    ...
    public void acceptRequest() {
        ...
        if (!isloadedAddress) {
            generalFunc.showGeneralMessage("", generalFunc.retrieveLangLBl("", "LBL_WAIT_FOR_ADDRESS"));
            return;
        }
            ...
            public void setResponse(String responseString) {
                ...
                if (responseString != null && !responseString.equals("")) {
                    ...
                    if (isDataAvail == true) {
                        ...
                        map.put("eTollSkipped", generalFunc.getJsonValue("eTollSkipped", message_json));
                        map.put("vVehicleType", generalFunc.getJsonValue("vVehicleType", message_json));
...
//        catch (IllegalStateException e) { } catch (Exception e) { }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (generalFunc.retrieveValue(CommonUtilities.APP_TYPE).equals("Delivery"))
        {
